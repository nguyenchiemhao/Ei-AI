...
| Version | 1.0 |
| Updated | 2026-09-15 |
| Phase in flight | **Phase 1 · Foundation** — **G1 complete**, WP-2.1 · WP-2.2 · WP-2.5 · WP-3.1 closed |
...
| Code written | WP-1.1 the stack boots; WP-1.2 the schema migrates and seeds; WP-2.5 the boundaries refuse in CI; WP-3.1 a person can log in, refresh, be locked out and be revoked |
| Phase 1 progress | **65 / 154 tasks · 237 / 700 h** — all closed at their gates; `T-2.2-05` deferred |
